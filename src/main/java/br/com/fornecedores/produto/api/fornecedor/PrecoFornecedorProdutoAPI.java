...
public interface PrecoFornecedorProdutoAPI {
    ...
    ResponseEntity<FornecedorProdutoResponse> findByGtin(@PathVariable
                                                         @NotBlank
                                                         @Size(min = 1, max = 20)
    ...
    ResponseEntity<?> criarPedidos(@Valid @RequestBody FornecedorProdutoRequest precoFornecedorProdutoRequest) throws NegocioException, IndisponivelException, NaoEncontradoException;
}
